...
import requests
from requests import RequestException#这是什么？
from bs4 import BeautifulSoup
import time
import pandas as pd#pandas是干啥的？
import re#正则？
import os#os是干啥的？
proxy=False
frequency = 5
...
def crawl_one_xiaoqu(xiaoquinfo):
    """
    分别对：
    https://bj.lianjia.com/xiaoqu/1111027374308/
    https://bj.lianjia.com/ershoufang/c1111027374308/
    https://bj.lianjia.com/chengjiao/c1111027374308/
    https://sz.lianjia.com/zufang/c1111027374308/
    进行抓取，并保存到同一个excel中
    """
...
if __name__=='__main__':#运行此python的入口
    crawl_xiaoqu()#调取此方法
    # crawl_xiaoqu_info()
    # merge_data()